...
function RstLbls() {
  ...
  var wattsLoad = document.getElementById("watts").value;
  var mtrKh = document.getElementById("mtrKh").value;
  var mtrKe = document.getElementById("pulseKe").value;  
  var resultPlseTime = wattsLoad / mtrKh / mtrKe;
  document.getElementById("testResult").innerHTML=result + resultPlseTime;
